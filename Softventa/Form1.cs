...
namespace Softventa
{
    public partial class Form1 : Form
    {
        ...
        private void listarVentasfiltrosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Listarventasform n = new Listarventasform();
            n.MdiParent = this;
            n.Show();
        }
        ...
        {
            Realizarbalanceform d = new Realizarbalanceform();
            d.MdiParent = this;
            d.Show();
        }
        ...
        {
            Listarsucursalform a = new Listarsucursalform();
            a.MdiParent = this;
            a.Show();
        }
        ...
        private void realizarBalanceToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Realizarbalanceform d = new Realizarbalanceform();
            d.MdiParent = this;
            d.Show();
        ...
        private void realizarBalanceToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Realizarbalanceform d = new Realizarbalanceform();
            d.MdiParent = this;
            d.Show();
